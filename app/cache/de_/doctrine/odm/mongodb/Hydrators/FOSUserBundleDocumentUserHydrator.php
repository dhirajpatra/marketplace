...
class FOSUserBundleDocumentUserHydrator implements HydratorInterface
{
    ...
    public function hydrate($document, $data, array $hints = array())
    {
        ...
        /** @Field(type="boolean") */
        if (isset($data['locked']) || (! empty($this->class->fieldMappings['locked']['nullable']) && array_key_exists('locked', $data))) {
            $value = $data['locked'];
            if ($value !== null) {
                $typeIdentifier = $this->class->fieldMappings['locked']['type'];
                $return = (bool) $value;
            } else {
                $return = null;
            }
        ...
        /** @Field(type="boolean") */
        if (isset($data['expired']) || (! empty($this->class->fieldMappings['expired']['nullable']) && array_key_exists('expired', $data))) {
            $value = $data['expired'];
            if ($value !== null) {
                $typeIdentifier = $this->class->fieldMappings['expired']['type'];
                $return = (bool) $value;
            } else {
                $return = null;
            }
