 ...
 */
class Area extends \Cocorico\GeoBundle\Entity\Area implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Cocorico\\GeoBundle\\Entity\\Area' . "\0" . 'id', '' . "\0" . 'Cocorico\\GeoBundle\\Entity\\Area' . "\0" . 'country', '' . "\0" . 'Cocorico\\GeoBundle\\Entity\\Area' . "\0" . 'departments', '' . "\0" . 'Cocorico\\GeoBundle\\Entity\\Area' . "\0" . 'cities', '' . "\0" . 'Cocorico\\GeoBundle\\Entity\\Area' . "\0" . 'coordinates', 'translations', 'newTranslations', 'currentLocale', 'defaultLocale', 'geocoding'];
        }
