 ...
 */
class Department extends \Cocorico\GeoBundle\Entity\Department implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Cocorico\\GeoBundle\\Entity\\Department' . "\0" . 'id', '' . "\0" . 'Cocorico\\GeoBundle\\Entity\\Department' . "\0" . 'country', '' . "\0" . 'Cocorico\\GeoBundle\\Entity\\Department' . "\0" . 'area', '' . "\0" . 'Cocorico\\GeoBundle\\Entity\\Department' . "\0" . 'cities', '' . "\0" . 'Cocorico\\GeoBundle\\Entity\\Department' . "\0" . 'coordinates', 'translations', 'newTranslations', 'currentLocale', 'defaultLocale', 'geocoding'];
        }
