 ...
 */
class Geocoding extends \Cocorico\GeoBundle\Entity\Geocoding implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Cocorico\\GeoBundle\\Entity\\Geocoding' . "\0" . 'id', 'lat', 'lng', 'viewport', 'addressType'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Geocoding $proxy) {
    ...
    public function getViewport()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getViewport', []);
    ...
    public function setViewport($viewport)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setViewport', [$viewport]);

        return parent::setViewport($viewport);
    }
