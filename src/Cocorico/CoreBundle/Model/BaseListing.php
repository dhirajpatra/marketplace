...
abstract class BaseListing
{
     ...
     * for the time being it is static fee and not be deducted from main it will be addition.
     *
     * @param float $feeAsOfferer
     *
     * @return float
    ...
    {
        return $this->getAmountFeeAsOffererDecimal($feeAsOfferer);
