...
//        self::STATUS_CANCELED_OFFERER,
     ...
     * we are not taking any % taking static fee.
     *
     * @return int
     */
    ...
    /**
     * Total booking amount excluding vat to pay to asker.
     *
     *
     * @param float $vatRate
     *
     * @return int
     */
    public function getAmountToPayToAskerExcludingVAT($vatRate)
    {
        return $this->getAmountToPayToAsker() / (1 + $vatRate);
    }

    /**
     * Total booking amount decimal excluding vat to pay to asker.
     *
     * @param float $vatRate
     *
     * @return int
     */
    public function getAmountToPayToAskerExcludingVATDecimal($vatRate)
    {
        return $this->getAmountToPayToAskerExcludingVAT($vatRate) / 100;
    }
    ...
    public function amountFeeAsOffererForPriceExcludingVATDecimal($vatRate)
    {
        return $this->amountFeeAsOfferer + $this->amountFeeAsOfferer * $vatRate;
    }

    public function amountFeeAsAskerForPriceExcludingVATDecimal($vatRate)
    {
        return $this->amountFeeAsAsker + $this->amountFeeAsAsker * $vatRate;
    }
